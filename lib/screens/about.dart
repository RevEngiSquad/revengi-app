...
class _AboutScreenState extends State<AboutScreen> {
  Future<List<Contributor>>? sponsorssFuture;
  Future<Release>? releaseFuture;

  @override
  void initState() {
    super.initState();
    sponsorssFuture = fetchSponsors();
    releaseFuture = fetchLatestRelease();
  }

  Future<List<Contributor>> fetchSponsors() async {
    try {
      final response = await dio.get('https://revengi.in/sponsors.json');
